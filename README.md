...
### 1. Home Page
* **Standard View:**
![Home Page](wireframes/pictures/home.png)
* **With Design Constraints (Notes):**
![Home Notes](wireframes/pictures/home_with_notes.png)

### 2. User Authentication
![Log In / Sign Up](wireframes/pictures/login.png)

### 3. Creating Content
![Make Post](wireframes/pictures/make_post.png)

### 4. User Profiles
* **Viewing Own Profile (with Edit options):**
![Own Profile](wireframes/pictures/profile_own.png)
* **Viewing Other's Profile (Logged In):**
![Other Profile](wireframes/pictures/profile_other.png)
* **Viewing Other's Profile (Logged Out):**
![Logged Out Profile](wireframes/pictures/profile_logged_out.png)